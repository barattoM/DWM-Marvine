...
{
  add_menu_page( 'WP Tic-Tac-Toe', 'Wp Tic-Tac-Toe', 'manage_options', 'wptictactoe-dashboardpage', 'WPTTT_GAME_Admin', 'dashicons-grid-view');
}
...
<p class="WPTTT_settings-intro">
	...
	<p class="WPTTT_settings-intro"> Add the game to your sidebar, from <b>Appearance >> Widgets </b>, or Use the shortcode in a page.  </p>
...
add_action( 'widgets_init', create_function( '', 'register_widget("WPTTT_WIDGET");' ) ); ?>