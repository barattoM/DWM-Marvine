...
--
-- Host: localhost    Database: gestionstation
-- ------------------------------------------------------
...
--
-- Current Database: `gestionstation`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `gestionstation` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
INSERT INTO `reservations` VALUES (3,1,1,'2019-04-20','2019-05-07','2019-05-09',2400,800),(4,1,3,'2019-11-04','2019-11-13','2019-11-17',400,50),(5,2,2,'2020-01-11','2020-02-12','2020-02-18',3400,100),(6,2,4,'2019-06-19','2019-08-05','2019-08-18',7200,180),(7,3,5,'2019-04-02','2019-04-29','2019-05-03',1400,450),(8,4,6,'2019-10-20','2019-12-01','2019-12-15',2400,780),(9,4,6,'2019-02-27','2019-03-31','2019-04-04',500,80),(10,4,8,'2019-07-21','2019-08-16','2019-08-16',40,0),(11,8,15,'2019-10-12','2019-11-23','2019-11-29',580,58),(12,9,17,'2019-12-22','2020-01-27','2020-01-30',140,14),(13,8,15,'2019-07-21','2019-08-18','2019-08-21',360,36),(14,4,20,'2019-01-10','2019-02-20','2019-03-01',1380,138),(15,13,16,'2019-04-09','2019-04-17','2019-05-02',420,42),(16,13,16,'2019-05-21','2019-06-13','2019-06-26',360,36),(17,12,1,'2019-07-26','2019-08-09','2019-08-20',680,68),(18,21,15,'2019-11-29','2019-11-30','2019-12-14',1280,128),(19,14,19,'2019-03-12','2019-04-06','2019-04-09',420,42),(20,24,12,'2019-01-17','2019-01-24','2019-01-28',260,26),(21,12,9,'2020-01-02','2020-02-15','2020-02-24',1380,138),(22,4,12,'2019-09-10','2019-09-24','2019-10-01',1430,143),(23,23,1,'2019-05-11','2019-06-10','2019-06-14',820,82),(24,10,11,'2019-10-21','2019-10-24','2019-10-31',650,65),(25,20,14,'2020-01-12','2020-03-04','2020-03-09',1290,129),(26,15,19,'2019-04-02','2019-05-02','2019-05-09',1030,103),(27,17,17,'2019-01-04','2019-02-15','2019-02-25',470,47),(28,14,16,'2019-05-17','2019-05-31','2019-06-03',1460,146),(29,21,6,'2019-04-12','2019-05-23','2019-05-28',1310,131),(30,20,9,'2019-06-26','2019-07-15','2019-07-21',460,46),(31,18,17,'2019-04-09','2019-05-23','2019-05-27',350,35),(32,23,14,'2019-06-14','2019-08-02','2019-08-04',890,89),(33,12,14,'2019-03-06','2019-03-23','2019-03-31',1440,144),(34,19,17,'2019-03-27','2019-04-29','2019-05-07',1010,101),(35,16,13,'2019-02-11','2019-03-08','2019-03-22',790,79),(36,2,5,'2019-04-15','2019-04-23','2019-05-04',270,27),(37,19,19,'2019-03-25','2019-05-02','2019-05-16',660,66),(38,4,13,'2019-05-01','2019-06-14','2019-06-18',140,14),(39,19,14,'2020-01-10','2020-02-24','2020-02-29',1460,146),(40,4,6,'2019-11-24','2019-11-30','2019-12-01',790,79),(41,20,15,'2020-01-13','2020-01-30','2020-02-14',390,39);
