    ...
    switch ($jeu) {
        ...
        case "P":
            ...
            do {
                $alpha = $coordonnee[0];
                $numCol = ord($alpha) - ord("A");
            } while (!ctype_alpha($coordonnee[0]));
            return $numCol;
            break;
    }
 ...
 *
 * @param array $plateau
 * @param string $jeu Si M : Morpion, si P : Puissance 4.
 * @return bool
 */
 ...
 * @param int $numCol   Numéro de colonne ou la fonction doit trouver la case vide la plus basse
 * @return array
 */
