...
$e1 = new Employe(["nom"=>"Dupont","prenom"=>"Martin","dateEmbauche" => $date1,"poste"=>"Comptable", "salaire" => 50,"service"=>"Comptabilité","agence"=>$agence1]);
$e2 = new Employe(["nom"=>"Dupont","prenom"=>"Jean","dateEmbauche" => $date2,"poste"=>"faef", "salaire" => 10,"service"=>"rza","agence"=>$agence2]);
$e3 = new Employe(["nom"=>"Dufour","prenom"=>"Toto","dateEmbauche" => $date3,"poste"=>"zv", "salaire" => 15,"service"=>"trh","agence"=>$agence3]);
$e4 = new Employe(["nom"=>"Arnold","prenom"=>"Tata","dateEmbauche" => $date4,"poste"=>"Comptable", "salaire" => 20,"service"=>"Comptabilité","agence"=>$agence2]);
$e5 = new Employe(["nom"=>"Bupour","prenom"=>"Martin","dateEmbauche" => $date5,"poste"=>"fa", "salaire" => 30,"service"=>"dad","agence"=>$agence1]);
...
$enfant3=new Enfant(["nom"=>"Arnold","prenom"=>"Giselle","dateNaissance"=>$date3]);
...
foreach($listeEmploye as $elt){
    if($elt->chequesVacances()){
        echo $elt->getNom()." ".$elt->getPrenom()." peut recevoir des ticket restaurant\n";
    }
    else{
        echo $elt->getNom()." ".$elt->getPrenom()." ne peut pas recevoir de ticket restaurant\n";
    }
}