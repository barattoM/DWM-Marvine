...
class Employe
{
    ...
    public function toStringHTML(){
        return "<br>Nom : " . $this->getNom() .
                "<br>Prenom : " . $this->getPrenom() .
                "<br>Date d'embauche : " . $this->getDateEmbauche()->format("d-m-Y") .
                "<br>Poste : " . $this->getPoste() .
                "<br>Salaire : " . $this->getSalaire() .
                "<br>Service : " . $this->getService() .
                "<br>******************Enfants**********************" .
                "<br>Il a " . count($this->getEnfants()) . " enfants : " .
                "<br>" . $this->affichageEnfants() ."<br><br>" ;
    }
